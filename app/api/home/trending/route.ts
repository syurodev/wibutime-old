...
export async function GET(
  ...
  try {
    ...
    const lightnovelTrendingPromise = findlLightnovelTrending(8, startOfWeek, endOfWeek);
    const topAnimePromise = findlAnimeTrending(8, startOfWeek, endOfWeek);
    const topMangaPromise = findlMangaTrending(8, startOfWeek, endOfWeek);

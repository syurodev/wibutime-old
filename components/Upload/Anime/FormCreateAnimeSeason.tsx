...
import { animeSeasonSchema } from '@/schemas/anime';
...
import { createAnimeSeason } from '@/actions/anime';
...
const FormCreateAnimeSeason: FC<IProps> = ({
  id,
  onOpenChange
}) => {
  ...
  const form = useForm<z.infer<typeof animeSeasonSchema>>({
    resolver: zodResolver(animeSeasonSchema),
    defaultValues: {
      name: "",
        ...
        <div className='flex flex-col lg:flex-row gap-6 w-full'>
          <div className='w-full space-y-6'>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Tên season<span className='text-destructive'>*</span></FormLabel>
                  <FormControl>
...
export default FormCreateAnimeSeason
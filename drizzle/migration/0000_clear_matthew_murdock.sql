...
CREATE TABLE IF NOT EXISTS "anime_episode" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"name" text NOT NULL,
	"content" json DEFAULT '{"key":"","url":""}'::json NOT NULL,
	"thumbnail" json DEFAULT '{"key":"","url":""}'::json NOT NULL,
...
CREATE TABLE IF NOT EXISTS "anime_season" (
	...
	"updated_at" timestamp DEFAULT now(),
	"deleted" boolean DEFAULT false,
	"image" json DEFAULT '{"key":"","url":""}'::json,
	"musics" json DEFAULT '[]'::json,
